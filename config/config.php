...
$username = "root";
$password = "";
$database_name = "perpustakaan_fajar";
...
function pinjamBuku($dataBuku) {
  ...
  // Tambahkan kolom status dengan nilai default "Tunggu konfirmasi"
  $status = "Tunggu konfirmasi";
  
  // Periksa apakah buku yang akan dipinjam sudah ada dalam daftar peminjaman pengguna
  $queryCekPeminjaman = "SELECT * FROM peminjaman WHERE id_buku = '$idBuku' AND nisn = '$nisn'";
  ...
  $queryPinjam = "INSERT INTO peminjaman (id_buku, nisn, id_admin, tgl_peminjaman, tgl_pengembalian, status) 
                VALUES ('$idBuku', '$nisn', '$idAdmin', '$tglPinjam', '$tglKembali', '$status')";
